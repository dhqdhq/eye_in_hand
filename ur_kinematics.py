...
def main():
    ...
    q5_5=[-0.59860155164,-1.82648800883,-0.41735542252,0.0812199084238,0.27000134315,0.234254316924]
    # q5=[-3.66249992472,-1.27642603705,-1.9559700595,0.0701396996895,1.3338858418,0.73287290524]
    c=Kinematic()
    #c.display(q5,q5,1)
    weights=[1.] * 6
    T=[0.72615767826,0.522825277035,-0.446484888879,0.460000000002,
        -0.687234758942,0.532993626597,-0.493585028247,-0.375,
        -0.0200851289894,0.665260493116,0.746341117649,0.553279699274,
        0.0,0.0,0.0,1.0]
    q6=c.Iverse(T,0.1)
    # print q6
    #c.best_sol(weights,q5_5,c.Forward(q5))
